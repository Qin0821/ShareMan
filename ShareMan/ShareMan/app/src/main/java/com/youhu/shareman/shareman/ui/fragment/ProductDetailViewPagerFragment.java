...
public class ProductDetailViewPagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.layout_bottom, null);
    }
    ...
    private class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ImageView imageView = view.findViewById(R.id.ig_product_detail);

            //设置显示图片
            imageView.setImageResource(R.drawable.banne_samll);
