...
public class XListView extends ListView implements OnScrollListener {
    ...
    private boolean isNeedNoneState = true;
    // feature.
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mLastY = ev.getRawY();
                /**Yangmu*/
                if (deltaY < -60 && callBack != null) {
                    callBack.close();
                } else {
                    /**Yangmu*/
                    if (deltaY > 60 && getFirstVisiblePosition() <= 1 && callBack != null) {
                        callBack.expand();
                    }
                    /**Yangmu*/
                }
...
//                final float deltaY2 = ev.getRawY() - mLastY;
                mLastY = -1; // reset
...
//                }
    ...
    public void requestLayout() {
        ...
        if (getCount() <= getHeaderViewsCount() + getFooterViewsCount()) {
            mFooterView.setNoneDataState(isNeedNoneState);
            if (isPullLoad) {
...
//                setPullLoadEnable(true);
    ...
    /**
     * 设置是否需要在数据源为空时提醒‘没有任何数据’
     */
    public void setIsNeedNoneState(boolean isNeedNoneState) {
        this.isNeedNoneState = isNeedNoneState;
    }
