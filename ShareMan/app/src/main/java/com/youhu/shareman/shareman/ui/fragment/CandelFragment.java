...
public class CandelFragment extends ViewPagerBaseFragment {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        View view2 = inflater.inflate(R.layout.viewpager_cancel_item, null);
        View view3 = inflater.inflate(R.layout.viewpager_cancel_item, null);
